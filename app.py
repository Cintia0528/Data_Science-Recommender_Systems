...
movies = pd.read_csv('C:\\Users\\ubp05\\Desktop\\WBS Coding\\BOOTCAMP\\PROJECT 8 - RECOMMENDERS\\movies.csv')

ratings = pd.read_csv('C:\\Users\\ubp05\\Desktop\\WBS Coding\\BOOTCAMP\\PROJECT 8 - RECOMMENDERS\\ratings.csv')
...
# Banner
st.image("https://res.cloudinary.com/exclusivi/image/upload/v1702027196/Screenshot_2023-12-08_101904.png")


st.sidebar.title("""
Welcome back, `dudemeister112`
...
st.write("#### Are you feeling adventurous?...")
